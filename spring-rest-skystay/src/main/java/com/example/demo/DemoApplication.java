...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		Habitacion pruebaHabitacion3 = new Habitacion("Habitacion Individual", hotelRepo.findById(1L).get(), "Basic", 62.5, "Habitación basica individual", false, 225);
		adminRepo.save(pruebaAdmin1);
		habitacionRepo.save(pruebaHabitacion1);
		habitacionRepo.save(pruebaHabitacion2);
		habitacionRepo.save(pruebaHabitacion3);
